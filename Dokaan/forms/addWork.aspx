<%@ Page Title="" Language="C#" MasterPageFile="~/forms/mst.Master" AutoEventWireup="true" CodeBehind="addWork.aspx.cs" Inherits="Dokaan.forms.addWork" MaintainScrollPositionOnPostback="true" %>
        ...
        <div class="container-fluid">
            ...
            <div class="row pt-3 border-0 border-danger">
                <div class="col-lg-6 col-md-5 col-12 text-start ">
                    <asp:Button runat="server" ID="btnAddNew" Text="Add New Entry" CssClass="py-2 px-3 shade_2 t_white border-0" OnClick="btnAddNew_Click" />
                </div>
                ...
                <asp:UpdatePanel runat="server" ID="updtPnl">
                    <ContentTemplate>
                        <div class="table table-responsive">
                            <asp:GridView runat="server" ID="gvWork" DataKeyNames="work_master_id" AutoGenerateColumns="false" CssClass="w-100 text-nowrap small" AlternatingRowStyle-CssClass="grey_1 " OnRowEditing="gvWork_RowEditing"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Work Name" HeaderStyle-CssClass="t_white shade_2">
                                        <ItemTemplate>
                                            <div class="w-100 p-2">
                                                <a href='frmAddWork.aspx?id=<%# Eval("work_master_id") %>&back=addWork.aspx' class="text-decoration-none">
                                                    <%# Eval("work") %>
                                                </a>
                                            </div>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox runat="server" ID="txtWorkName" placeholder="Work Name" CssClass="w-100 p-2 border-0" Text='<%# Bind("work") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Tracking Link" HeaderStyle-CssClass="t_white shade_2">
                                        <ItemTemplate>
                                            <div class="w-100 p-2">
                                                <a href="<%# Eval("tracking_link") %>" class="mb-0" target="_blank">
                                                    <i class="fa fa-link text-dark"></i>
                                                </a>
                                            </div>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox runat="server" ID="txtTrackLink" placeholder="Tracking Link" CssClass="w-100 p-2 border-0 text-primary" Text='<%# Bind("tracking_link") %>' />
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
