<%@ Page Title="" Language="C#" MasterPageFile="~/forms/mst.Master" AutoEventWireup="true" CodeBehind="proccessWork.aspx.cs" Inherits="Dokaan.forms.proccess" %>
            ...
            <div class="row pt-3 mx-0 border-0 border-primary table table-responsive">
                <div class="col-12 px-0">
                    <asp:GridView runat="server" ID="gvWorkRecord" AutoGenerateColumns="false" CssClass="w-100 text-nowrap small" AlternatingRowStyle-CssClass="grey_1"
                        ...
                        OnRowDeleting="gvWorkRecord_RowDeleting" DataKeyNames="customer_id, work_id" OnRowDataBound="gvWorkRecord_RowDataBound">
                        <Columns>

                            <asp:TemplateField HeaderText="Name" HeaderStyle-CssClass="t_white shade_2 p-2">
                                <ItemTemplate>
                                    <div class="w-100 p-2">
                                        <a href='frmWorkEntry.aspx?bill_id=<%# Eval("bill_id") %>&c_id=<%# Eval("customer_id") %>&cw_id=<%# Eval("work_id") %>&from=proccessWork.aspx' class="text-decoration-none">
                                            <%# Eval("name") %>
                                        </a>
                                    </div>
                                </ItemTemplate>
