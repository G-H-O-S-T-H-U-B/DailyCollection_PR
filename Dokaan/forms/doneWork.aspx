<%@ Page Title="" Language="C#" MasterPageFile="~/forms/mst.Master" AutoEventWireup="true" CodeBehind="doneWork.aspx.cs" Inherits="Dokaan.forms.doneWork" %>
                    ...
                    <asp:GridView runat="server" ID="gvWorkRecord" AutoGenerateColumns="false" CssClass="w-100 text-nowrap small" AlternatingRowStyle-CssClass="grey_1"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Name" HeaderStyle-CssClass="t_white shade_2 p-2">
                                <ItemTemplate>
                                    <div class="w-100 p-2">
                                        <a href='frmWorkEntry.aspx?bill_id=<%# Eval("bill_id") %>&c_id=<%# Eval("customer_id") %>&cw_id=<%# Eval("work_id") %>&from=doneWork.aspx' class="text-decoration-none">
                                            <%# Eval("name") %>
                                        </a>
                                    </div>
                                </ItemTemplate>
